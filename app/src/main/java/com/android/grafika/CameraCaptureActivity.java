...
public class CameraCaptureActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGLView.setEGLConfigChooser(new SimpleEGLConfigChooser(false));
 ...
 */
class RecordableComponentSizeChooser extends BaseConfigChooser {
    // Android-specific extension.
    private static final int EGL_RECORDABLE_ANDROID = 0x3142;

    public RecordableComponentSizeChooser(int redSize, int greenSize, int blueSize,
 ...
 *
 */
class SimpleEGLConfigChooser extends RecordableComponentSizeChooser {
